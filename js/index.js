...
const createToast = ({status, title, desc, time})=>{
    ...
    const icon = {
        success: `<i class="fa-solid fa-circle-check toast_icon"></i>`,
        error: `<i class="fa-solid fa-circle-exclamation toast_icon"></i>`
    }
    const htmls =
    `
